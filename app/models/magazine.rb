class Magazine < ActiveRecord::Base
  ...
  validates :title, :genre, :start_date, :end_date, :payment, :magazineformat, :publicationcycle, :submissionlimit, :address_number, :street_name, :postal_code, :city_name, :province_name, :country_name, presence: true
